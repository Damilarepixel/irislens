...
const blogImages = {
  img1 : '../../../public/images/gallery/1.jpg',
  img2 : '../../../public/images/gallery/8.jpg',
  img3 : '../../../public/images/gallery/19.jpg'
}
    return (
      <div>
        ...
        <div className='blogContainer container'>
          <div style={{backgroundColor : blogBgColor}} className='blogs'>
            <div style={{backgroundImage : `url(${(blogImages.img1)})`}} className='blogsBg'></div>
          ...
          <div style={{backgroundColor : blogBgColor}} className='blogs'>
            <div style={{backgroundImage : `url(${(blogImages.img2)})`}} className='blogsBg'></div>
            <div className='blogTextContainer'>
          ...
          <div style={{backgroundColor : blogBgColor}} className='blogs'>
            <div style={{backgroundImage : `url(${(blogImages.img3)})`}} className='blogsBg'></div>
            <div className='blogTextContainer'>
